...
import 'package:cheon/components/tappable_text_span.dart';
import 'package:cheon/components/platform_loading_indicator.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PageTransitionSwitcher(
        ...
        child:
            revisionVM.revisionSetup ? _RevisionDashboard() : _RevisionSetup(),
      ),
    );
  }
}
